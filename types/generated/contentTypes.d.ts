...
export interface ApiAboutMeAboutMe extends Schema.CollectionType {
  ...
  attributes: {
    aboutText_1: Attribute.String;
    aboutText_2: Attribute.String;
    about_desc: Attribute.Text;
    about_skill: Attribute.String;
    about_img: Attribute.Media;
    about_work: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiHeroHero extends Schema.CollectionType {
  ...
  attributes: {
    hero_text_1: Attribute.String;
    hero_text_2: Attribute.String;
    hero_text_3: Attribute.String;
    hero_desc: Attribute.Text;
    ...
    about_img: Attribute.Media;
    about_work: Attribute.String;
    aboutText_3: Attribute.String;
    project1_text_1: Attribute.String;
    project1_text_2: Attribute.Text;
    project1_img: Attribute.Media;
    project2_text_1: Attribute.String;
    project2_text_2: Attribute.Text;
    project2_img: Attribute.Media;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
